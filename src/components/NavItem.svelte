...
{#if type == "folder"}
<a href={dest} class="flex flex-col items-center justify-center gap-y-1 text-xs px-1 hover:bg-{hover_color} text-{text_color}">
    <svg class="stroke-0 w-16 fill-{color}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96.69 96">
